        ...
        <form id="form-signup" method="post">
            <div class="form-group has-feedback">
                <input type="text" id="fullname" class="form-control" placeholder="Full Name" name="fullname"
                       ...
                       data-validation-error-msg="User name has to be an alphanumeric value (3-100 chars)"
                       data-validation-allowing="-_ ">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Email" name="email" data-validation="email">
            ...
            <div class="form-group has-feedback">
                <input type="password" id="verifyPassword" class="form-control" placeholder="Retype password"
                       name="verifyPassword" data-validation="required">
                <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" id="phoneNumber" class="form-control" placeholder="Phone number" name="phoneNumber"
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-6">
                    <button type="submit" value="Validate" class="btn btn-primary btn-block btn-flat" name="register">
                        Register
                    </button>
...
<script>
    /* $("#orm-signup").validate();
     ...
     equalTo: "Retyped password must be the same with password"
     },
     phoneNumber: {
