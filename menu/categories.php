...
<section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <button type="submit" class="btn btn-primary " id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Add Category</button>
        ...
        <div class="box-body">
         <table id="table_categories" class="table table-striped table-bordered table-hover">
                    <thead>
