...
$(document).on("click", "#btnsave", function () {
    ...
    var regex = /^[a-zA-Z -]*$/;
    if (name == '' || name == null) {
        swal("Warning", "Ju lutem shkruani emertimin e ingredient!", "warning");
        $("#txtname").focus();
        return;
    }
    if (!(regex.test(name))) {
        swal("Warning", "Ne emertim te ingredients pranohen vetem germa te alfabetit!", "warning")
        $("#txtname").focus();
        return;
    }
    var value = {
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if (data.crud == 'N') {
                    if (data.result == 1) {
                        ...
                        swal("Error", "This ingredient already exists, please choose another ingredient name");
                    }
                    ...
                    if (data.result == 1) {
                        ...
                        swal("Error", "This ingredient already exists, error : " + data.error, "error");
                    }
                } else {
