                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="menu/products.php">Products</a></li>
                            <li class="divider"></li>
                            <li><a href="menu/categories.php">Categories</a></li>
                            <li class="divider"></li>
                            <li><a href="menu/ingredients.php">Ingredients</a></li>
                            <li class="divider"></li>
                            <li><a href="menu/size.php">Size</a></li>
                            <!--  <li class="divider"></li>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="menu/user_images/<?=$userInfo['userPicture'] ?>" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="menu/user_images/<?=$userInfo['userPicture'] ?>" class="img-circle" alt="User Image">
                            </li>
                            <!-- Menu Body -->
                            <!--     <li class="user-body">
                                   <div class="row">
                        ...
                        <li class="user-footer">
                                 <div class="pull-left">
                                    <a href="menu/editUser.php" class="btn btn-default btn-flat">Profile</a>
                                </div>
                          <div class="pull-left">
                         <a href="menu/ChangePassword.php" class="btn btn-default btn-flat">Privacy</a>
                          </div>
